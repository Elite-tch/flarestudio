...
var WalletModule = class {
  ...
  async getBalance() {
    ...
    try {
      ...
      return {
        flr: ethers.formatEther(balance)
  ...
  async send(options) {
    ...
    try {
      const tx = {
        to: options.to,
        value: options.value ? ethers.parseEther(options.value) : void 0,
        data: options.data
      };
...
var FDCModule = class {
  ...
  async getFdcHubAddress() {
    ...
    try {
      const registry = new ethers.Contract(this.contractRegistryAddress, CONTRACT_REGISTRY_ABI2, this.provider);
  ...
  async verifyBitcoinPayment(params, signer) {
    try {
      ...
      const fdcHub = new ethers.Contract(hubAddr, FDC_HUB_ABI, signer);
  ...
  async getRecentAttestations(options = {}) {
    try {
      const hubAddr = await this.getFdcHubAddress();
      const fdcHub = new ethers.Contract(hubAddr, FDC_HUB_ABI, this.provider);
  ...
  subscribe(callback) {
    ...
    const setup = async () => {
      try {
        const hubAddr = await this.getFdcHubAddress();
        fdcHub = new ethers.Contract(hubAddr, FDC_HUB_ABI, this.provider);
...
var StakingModule = class {
  ...
  async wrap(amount, signer) {
    try {
      const wnat = new ethers.Contract(this.wnatAddress, WNAT_ABI, signer);
  ...
  async getWNatBalance(address) {
    try {
      const wnat = new ethers.Contract(this.wnatAddress, WNAT_ABI, this.provider);
  ...
  async getVotePower(address) {
    try {
      ...
      return ethers.formatEther(votePower);
    } catch (error) {
      throw new StakingError(
  ...
  async getUnclaimedReward(address, epoch) {
    try {
      ...
      return ethers.formatEther(totalReward);
    } catch (error) {
      throw new StakingError(
...
var FAssetsModule = class {
  ...
  async getFAssetAddress(assetManagerAddress) {
    const assetManager = new ethers.Contract(assetManagerAddress, ASSET_MANAGER_ABI, this.provider);
  ...
  async getBalance(address, symbol) {
    try {
      ...
      const fAsset = new ethers.Contract(fAssetAddress, IERC20_ABI, this.provider);
  ...
  async getCollateralRequirements(symbol, lots) {
    try {
      ...
      return {
        required: ethers.formatEther(fee),
        currency: "FLR"
...
var StateConnectorModule = class {
  ...
  async getStateConnectorAddress() {
    ...
    try {
      const registry = new ethers.Contract(this.contractRegistryAddress, CONTRACT_REGISTRY_ABI5, this.provider);
  ...
  async getLastConfirmedRoundId() {
    try {
      ...
      const sc = new ethers.Contract(addr, STATE_CONNECTOR_ABI, this.provider);
  ...
  subscribeToFinalizedRounds(callback) {
    ...
    const setup = async () => {
      try {
        ...
        sc = new ethers.Contract(addr, STATE_CONNECTOR_ABI, this.provider);
  ...
  _initializeProvider() {
    try {
      if (this._config.provider) {
        ...
        this._provider = new ethers.JsonRpcProvider(this._config.rpcUrl);
      }
...
exports.FAssetsError = FAssetsError;
exports.FAssetsModule = FAssetsModule;
exports.FDCError = FDCError;
exports.FDCModule = FDCModule;
exports.FTSOError = FTSOError;
exports.FTSOModule = FTSOModule;
exports.FlareSDK = FlareSDK;
exports.NETWORKS = NETWORKS;
exports.SDKError = SDKError;
exports.StakingError = StakingError;
exports.StakingModule = StakingModule;
exports.StateConnectorError = StateConnectorError;
exports.StateConnectorModule = StateConnectorModule;
